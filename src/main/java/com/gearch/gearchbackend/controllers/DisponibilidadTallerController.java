...
// Controlador publico de disponibilidad, usado por el cliente para ver horarios y horas libres
@RestController
...
public class DisponibilidadTallerController {
    ...
    // Devuelve el horario semanal completo del taller (todos los dias que trabaja)
    ...
    // Si no hay disponibilidad ese dia devuelve un mensaje explicativo
