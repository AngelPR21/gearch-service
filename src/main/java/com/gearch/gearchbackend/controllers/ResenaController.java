...
// Controlador para las operaciones de resenas
@RestController
...
public class ResenaController {
    ...
    // Devuelve todas las resenas de un taller (usado en DetalleTaller)
    ...
    // Devuelve todas las resenas escritas por un usuario
    ...
    // Crea una nueva resena de un usuario sobre un taller
    @PostMapping
